...
public class DayDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String dayNumber = intent.getStringExtra("DAY_NUMBER");
        exercises = intent.getStringExtra("EXERCISES").split("\n");
        int minutes = intent.getIntExtra("TIMER", 12);  // Default to 12 minutes if not provided

        dayTextView.setText(dayNumber);
        exercisesTextView.setText(intent.getStringExtra("EXERCISES"));
    ...
    private void saveCompletionStatus(String dayNumber) {
        SharedPreferences sharedPreferences = getSharedPreferences("DayCompletionStatus", MODE_PRIVATE);
