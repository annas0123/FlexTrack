...
public class DaysAdapterHard extends RecyclerView.Adapter<DaysAdapterHard.DayViewHolder> {
    ...
    public DaysAdapterHard(List<Day> daysList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull DayViewHolder holder, int position) {
        ...
        SharedPreferences sharedPreferences = holder.itemView.getContext().getSharedPreferences("DayCompletionStatusHard", Context.MODE_PRIVATE);
