...
public class DaysAdapterMedium extends RecyclerView.Adapter<DaysAdapterMedium.DayViewHolder> {
    ...
    public DaysAdapterMedium(List<Day> daysList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull DayViewHolder holder, int position) {
        ...
        SharedPreferences sharedPreferences = holder.itemView.getContext().getSharedPreferences("DayCompletionStatusMedium", Context.MODE_PRIVATE);
