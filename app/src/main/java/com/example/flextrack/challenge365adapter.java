...
public class challenge365adapter extends RecyclerView.Adapter<challenge365adapter.DayViewHolder> {
    ...
    public challenge365adapter(List<Day> daysList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull DayViewHolder holder, int position) {
        ...
        SharedPreferences sharedPreferences = holder.itemView.getContext().getSharedPreferences("ChallengeCompletionStatus", Context.MODE_PRIVATE);
