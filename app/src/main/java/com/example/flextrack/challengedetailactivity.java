...
public class challengedetailactivity extends AppCompatActivity {
    ...
    private static final long ONE_MINUTE_IN_MILLIS = 60000; // 60 seconds in milliseconds
    private static final long THIRTY_SECONDS_IN_MILLIS = 30000; // 30 seconds in milliseconds
    private GifImageButton exerciseGif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_challengedetailactivity);
        ...
        String dayNumber = intent.getStringExtra("DAY_NUMBER_365");
        exercises = intent.getStringExtra("EXERCISES_365").split("\n");
        int minutes = intent.getIntExtra("TIMER_365", 12);  // Default to 12 minutes if not provided

        dayTextView.setText(dayNumber);
        exercisesTextView.setText(intent.getStringExtra("EXERCISES_365"));
    ...
    private void saveCompletionStatus(String dayNumber) {
        SharedPreferences sharedPreferences = getSharedPreferences("ChallengeCompletionStatus", MODE_PRIVATE);
    ...
    private void startRestTimer(long timeInMillis) {
        exercisesTextView.setText("Rest:");
        loadRestImage();
