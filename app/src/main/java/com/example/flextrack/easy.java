...
public class easy extends AppCompatActivity {
    ...
    private static final int REQUEST_CODE_DAY_DETAIL = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("DayCompletionStatus", MODE_PRIVATE);
        ...
        daysAdapter = new DaysAdapter(daysList, new DaysAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(Day day) {
                ...
                if (isDayCompleted) {
                    Toast.makeText(easy.this, dayNumber + " is already completed!", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(easy.this, DayDetailActivity.class);
                    intent.putExtra("DAY_NUMBER", day.getDayNumber());
                    intent.putExtra("EXERCISES", getExercisesForDay(day.getDayNumber()));
                    intent.putExtra("TIMER", day.getMinutes()); // Pass the minutes to the detail activity
    ...
    private String getExercisesForDay(String dayNumber) {
        ...
        // Easy level workout plan - 8-10 exercises per day (1 minute each)
        day1 = "Jumping Jacks\n" +
                "Squats\n" +
                "Push-ups\n" +
                "Plank\n" +
